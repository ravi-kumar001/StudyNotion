      ...
      <div className='flex flex-col  text-white w-11/12 max-w-maxContent mx-auto pt-14' >
          ...
          <div className='lg:w-[50%] flex flex-wrap flex-row justify-between lg:border-r lg:border-richblack-700 pl-3 lg:pr-5 gap-3' >
            ...
            <div className='w-[48%] lg:w-[30%] flex flex-col gap-3 ' >
              ...
              <div className='flex gap-3 text-lg text-richblack-400 -mt-5'>
                <Link target='_blank' to={'https://github.com/ravi-kumar001'} ><FaLinkedin /></Link>
                <Link target='_blank' to={'https://twitter.com/'} ><FaTwitter /></Link>
                <Link target='_blank' to={'https://www.youtube.com/@team-fanfeet'} ><FaYoutube /></Link>
                <Link target='_blank' to={'https://www.facebook.com/ravikumar.patel.7758/'} ><FaFacebook /></Link>
                <Link target='_blank' to={'https://www.instagram.com/ravi_kumar_0_0_0/'} ><FaInstagram /></Link>
              </div>
            </div>
        ...
        <div className='flex flex-col lg:flex-row justify-between items-center text-richblack-400 text-sm py-14' >
          ...
          <div className='text-center' >
            Made with ❤️ Team FanFeet © Aug,2024 StudyNotion
          </div>
        </div>
      </div>
    </div>
