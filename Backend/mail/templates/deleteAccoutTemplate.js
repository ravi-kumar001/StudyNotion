const deleteAccoutTemplate = (email, name) => {
  return `
      <!DOCTYPE html>
      <html lang="en">
    <head>
    ...
    <body>
      <div class="container">
        ...
        <!-- Body -->
        <div class="body">
          <p class="message">Your Account Delete Successfully</p>
  
          <p>Hey ${name},</p>
          <p>Your Account has been deleted successfully updated for the email <span class="highlight">${email}</span>.</p>
        </div>
...
module.exports = deleteAccoutTemplate;
